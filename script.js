const gameSteps = [
  {
    title: '小美的困境',
    scenario: '小美母親是排灣族...不能申請大學保障名額。',
    question: '你覺得這樣公平嗎？',
    options: [
      { text: '不公平！她明明很認同排灣族文化', emotion: '😢', response: '小美眼中含淚："謝謝你理解我..."' },
      { text: '法律就是法律，必須遵守', emotion: '😞', response: '小美低下頭："我知道...但還是很難過"' }
    ]
  },
  {
    title: '美娟的無奈',
    scenario: '美娟是布農族女性...孩子就能輕易取得身分。',
    question: '這種差別待遇公平嗎？',
    options: [
      { text: '太不公平！這是性別歧視', emotion: '😡', response: '美娟憤怒地說："為什麼女性就要承受這種不平等？"' },
      { text: '社會習慣難改變，只能接受', emotion: '😔', response: '美娟無奈嘆息："身為女性真的很吃虧..."' }
    ]
  },
  {
    title: '阿明的選擇',
    scenario: '阿明是泰雅族...但孩子失去機會了"',
    question: '如果你是阿明，會怎麼選？',
    options: [
      { text: '讓孩子從父姓，保住原住民身分', emotion: '😔', response: '阿明嘆氣："為了孩子的未來，但對不起老婆..."' },
      { text: '尊重妻子，從母姓', emotion: '😟', response: '阿明握拳："家庭和諧重要，但孩子失去機會了"' }
    ]
  },
  {
    title: '小華的困惑',
    scenario: '小華父母都是阿美族...卻沒有身分。',
    question: '你認為這種情況合理嗎？',
    options: [
      { text: '不合理！文化認同比血統重要', emotion: '🤔', response: '小華困惑："我雖有身分，但感覺小美比我更像原住民..."' },
      { text: '血統是客觀標準，比較公平', emotion: '😐', response: '小華點頭："至少血統是明確的，不會有爭議"' }
    ]
  },
  {
    title: '志工老師的觀察',
    scenario: '李老師在原住民部落當志工老師...文化傳承都很重要',
    question: '這讓你想到什麼？',
    options: [
      { text: '身分認定制度需要改革', emotion: '💭', response: '李老師深思："也許我們該重新思考什麼是真正的認同"' },
      { text: '重點是教育，不是身分', emotion: '😌', response: '李老師微笑："無論有沒有身分，文化傳承都很重要"' }
    ]
  },
  {
    title: '歷史的諷刺',
    scenario: '你知道嗎？...來「證明認同」。',
    question: '知道這個歷史後，你有什麼感想？',
    options: [
      { text: '太諷刺了！用被迫的姓氏證明認同？', emotion: '😱', response: '"沒錯！這根本是歷史的荒謬循環！"' },
      { text: '歷史複雜，但現在需要標準', emotion: '🤔', response: '"雖然歷史有問題，但總要有個標準吧..."' }
    ]
  }
];
